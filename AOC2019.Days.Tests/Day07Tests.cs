...
namespace AOC2019.Days.Tests
{
    public class Day07Tests : AbstractTests
    {
        ...
        {
            var results = new Day07().GetCombinations(new long[] { 1, 2, });
        ...
        public void CalculateOutput(long[] inputArray, long[] combination, int expected)
        {
        ...
        public void DaySevenPartOne()
        {
            ...
            var combinations = day.GetCombinations(new long[] { 0, 1, 2, 3, 4 });

            var input = ReadCommaSeperatedLine("Day07.txt", i => long.Parse(i)).ToArray();

            var maximum = combinations.Max(c => day.CalculateOutput(c, input, 0));
        }
               
        [Theory]
        [InlineData(new long[] { 3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26, 27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5 }, new long[] { 9, 8, 7, 6, 5, }, 139629729)]
        public void CalculateOutputUntilHalted(long[] inputArray, long[] combination, int expected)
        {
        ...
        public void DaySeventPartTwo()
        {
            ...
            var combinations = day.GetCombinations(new long[] { 5, 6, 7, 8, 9, });
