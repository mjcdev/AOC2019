            ...
            var inputModels = new[]
{
        ...
        [Fact]
        public void NumberOfOrbitalJumpsBetween()
        {
            var inputModels = new[]
            {
                new InputModel("COM", "B"),
                ...
                new InputModel("J", "K"),
                new InputModel("K", "L"),
                new InputModel("K", "YOU"),
                new InputModel("I", "SAN"),
            };

            var result = new Day06().NumberOfOrbitalJumpsBetween("YOU", "SAN", inputModels);

            result.Should().Be(4);
        }

        [Fact]
        public void DaySixPartTwo()
        {
            var inputs = ReadLineSeperatedFile(
                "Day06.txt",
                i =>
            ...
            var result = new Day06().NumberOfOrbitalJumpsBetween("YOU", "SAN", inputs);
        }
    }
}
